...
class Test {
    public static void main(String[] args) {
        ...
        // linkedList.replace(1, node5);
        // linkedList.remove(0);
        // linkedList.addAt(5, node5);
        
        // System.out.println(linkedList.getEntry(0).item);
        // System.out.println(linkedList.getEntry(1).item);
        // System.out.println(linkedList.getEntry(2).item);
        // System.out.println(linkedList.getEntry(3).item);
